package com.hzbank.redis.utils;
...
public class RedisUtil {
     ...
     */
    public static boolean hset(String key,String hKey,Object hValue) {
        try {
     ...
     * @return true 成功 false失败
     */
    public static boolean hset(String key,String hKey,Object hValue,long time) {
        try {
            redisTemplate.opsForHash().put(key, hKey, hValue);
            if(time>0){
                expire(key, time);
     ...
     * @return
     */
    public static double hincr(String key, String hKey,double by){
     ...
     * @return
     */
    public static double hdecr(String key, String hKey,double by){
        return redisTemplate.opsForHash().increment(key, hKey,-by);
    }
